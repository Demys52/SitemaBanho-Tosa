    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <form action="{{route('servico.incluirServico', $servico->id)}}" method="post">
                        {{csrf_field()}}
                @if ($errors->any())
                ...
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                        <b>Incluindo Serviço a OS </b>{{$servico->id}}<br>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($servicos as $servico)
                            <tr>
                                <th scope="row"><input type="hidden" name="servico_id[]" value='{{$servico->id}}'></th>
                                <td>{{$servico->nome}}</td>
                        ...
                        @endforeach
                            <tr>
                                <td colspan="4"><p><b>Valor Total:</b></p></td>
                            ...
                            <button  onclick="zerarquantidade();" class="btn btn-info">Incluir</button>
                </form>
                </div>
            </div>        
        </div>
